...
float custom_atof(const char *str)
{
  ...
  while (*str)
  {
    ...
    else if (*str >= '0' && *str <= '9')
    {
      ...
      {
        value += (*str - '0') * fraction_factor;
        fraction_factor *= 0.1f;
      }
    }
    else if (*str == ',' || *str == '\n')
    {
