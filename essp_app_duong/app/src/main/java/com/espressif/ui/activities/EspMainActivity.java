...
public class EspMainActivity extends AppCompatActivity {
    ...
    private Button contro1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_esp_main);
        contro1=findViewById(R.id.carmera);
        contro1.setOnClickListener(v -> {
            // Tạo Intent để chuyển sang JoystickActivity
            Intent intent = new Intent(EspMainActivity.this, robot_can_bang_Activity.class);
            startActivity(intent);
        });

//        contro=findViewById(R.id.joystickviewcontro);
//        contro.setOnClickListener(v -> {
//            // Tạo Intent để chuyển sang JoystickActivity
//            Intent intent = new Intent(EspMainActivity.this, ControlActivity.class);
//            startActivity(intent);
//        });
        //Chuyển qua màn hình joystick sau khi nhấn nút
//        btnjoystickView = findViewById(R.id.joystickview);
//        btnjoystickView.setOnClickListener(v -> {
//            // Tạo Intent để chuyển sang JoystickActivity
//            Intent intent = new Intent(EspMainActivity.this, JoyStick.class);
//            startActivity(intent);
//        });
